...
Section Separation.
  ...
  (* Lemma rsDown_downLock_free_cases: *)
  ...
  Proof.
    ...
    - inv_steps.
      ...
      + right; apply (DisjList_cons_inv eq_nat_dec); [assumption|].
        ...
        (** [~ In rsDown eouts]: already proven by [rsDown_atomic_messages_indep]
         * in RsDownRed.v. Need to refactor all related lemmas. *)
        admit. 
  Admitted.
  ...
  (*! TODO: Separation by an RqDown message *)
