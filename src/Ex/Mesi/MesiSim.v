    ...
    - (*! Cases for L1 caches *)
      ...
      + (* [l1GetSRsDownDownS] *)
        ...
        { intro Hx; subst.
          ...
          eapply DisjList_In_1 in H27; [|eassumption].
          elim H27; rewrite c_li_indices_head_rootOf by assumption.
          left; reflexivity.
        }
