...
Section InvWBDir.
  ...
  Proof. (* SKIP_PROOF_ON
    ...
    inv H1; [assumption
            |apply msi_InvWBDir_ext_in; auto
            |apply msi_InvWBDir_ext_out; auto
            |].
...
Section InvWBCoh.
  ...
  Ltac solve_InvWBCoh :=
    ...
    simpl in *;
    solve [exfalso; solve_msi|simpl; intros; intuition solve_msi].
  ...
  Proof. (* SKIP_PROOF_ON
    ...
    pose proof (msi_MsgConflictsInv
                  (@msi_RootChnInv_ok _ Htr) H) as Hpmcf.
    pose proof (MsiDownLockInv_ok H) as Hmdl.
    pose proof (msi_InvWBDir_ok H) as Hidir.
    inv H1; [assumption
            |apply msi_InvWBCoh_ext_in; auto
            |apply msi_InvWBCoh_ext_out; auto
            |].
