...
Let's try to synthesize rules for \objGetRq{C_1} first. Looking at the initial
...
\begin{figure}[h]
  \begin{tikzcd}[column sep=huge]
    \{ P(\cdot, M); C_1(\cdot, I); C_2(v, M) \}
    \arrow[r, Rightarrow, "\objGetRs{C_1}{v}"] \arrow[d, dash, "R_0"] &
    \{ P(\cdot, S); C_1(v, S); C_2(v, S) \} \arrow[d, dash, "R_0"] \\
    S(v) \arrow[r, "\objGetRs{S}{v}"] &
    S(v)
  \end{tikzcd}
...
Thanks to the initial state transition for \objGetRq{C_1}, we get a hint that
...
\begin{center}
  \msgrule{\objGetRq{C_1}}{\stOf{C_1} = I}{\intGetRq{C_1}{P}}{\top}, where
  \intGetRq{C_1}{P} is mapped to $\{ \stOf{C_2} = S; \stOf{P} = S \}$.
\end{center}
...
\begin{center}
  \msgrule{\intGetRq{C_1}{P}}{\top}{\intInvRq{P}{C_2}}{\top}, where
  \intInvRq{P}{C_2} is mapped to $\{ \stOf{C_2} = S \}$.
\end{center}

Lastly, a rule for $C_2$ is synthesized as below:

\begin{center}
  \msgrule{\intInvRq{P}{C_2}}{\top}{\intInvRs{C_2}{P}{\valOf{C_2}}}{\stOf{C_2} = S}
\end{center}
...
\begin{center}
  \msgrule{\intInvRs{C_2}{P}{v}}{\top}{\intGetRs{P}{C_1}{v}}{\stOf{P} = S}
\end{center}

\begin{center}
  \msgrule{\intGetRs{P}{C_1}{v}}{\top}{\objGetRs{C_1}{v}}{\stOf{C_1} = S \wedge
    \valOf{C_1} = v}
\end{center}
...
\begin{figure}[h]
  \begin{tikzcd}[row sep=large, column sep=large]
    \{ P(\cdot, M); C_1(\cdot, I); C_2(v, M) \}
    \arrow[d, "\intGetRq{C_1}{P}"] \arrow[r, dash, "R_0"] &
    S(v) \arrow["\objGetRs{S}{v}"]{6-2} \\
    \cdot \arrow[d, "\intInvRq{P}{C_2}"] & \\
    \cdot \arrow[d, "\intInvRs{C_2}{P}{v}"] & \\
    \cdot \arrow[d, "\intGetRs{P}{C_1}{v}"] & \\
    \cdot \arrow[d, "\objGetRs{C_1}{v}"] & \\
    \{ P(\cdot, S); C_1(v, S); C_2(v, S) \}
    \arrow[r, dash, "R_0"] & S(v)
  \end{tikzcd}
  \caption{A complete sequence of state transitions when $\stOf{C_1} = I$}
  \label{fig:complete-transitions-i}
\end{figure}

\refFig{fig:complete-transitions-i} presents the complete sequence of state
transitions for \objGetRq{C_1} with the precondition $\stOf{C_1} = I$.
