...
\newcommand{\intGetRq}[2]{\ensuremath{#1.\texttt{getRq()}:#2}}
\newcommand{\intSetRq}[2]{\ensuremath{#1.\texttt{setRq()}:#2}}

\newcommand{\msgrule}[4]{\ensuremath{#1: \{ #2 \} \xrightarrow{#3} \{ #4 \}}}
...
\refSec{concurrent-cases}, the synthesis would be correct but may induce
deadlocks.
...
\begin{itemize}
\item \msgrule{\objGetRq{C_i}}{\stOf{C_i} \geq S}{\objGetRs{C_i}{\valOf{C_i}}}{\top}
\item \msgrule{\objSetRq{C_i}{v}}{\stOf{C_i} = M}{\objSetRs{C_i}}{\valOf{C_i} = v}
\end{itemize}
...
\begin{itemize}
\item \msgrule{\objGetRq{C_1}}{\stOf{C_1} < S}{\intGetRq{C_1}{P}}{\top}, where
  $\intGetRq{C_1}{P}$ is mapped to $\{ \stOf{C_2} \neq M; \stOf{P} \geq S \}$.
\item \msgrule{\objGetRq{C_2}}{\stOf{C_2} < S}{\intGetRq{C_2}{P}}{\top}, where
...
\begin{itemize}
\item \msgrule{\objSetRq{C_1}{v}}{\stOf{C_1} \neq M}{\intSetRq{C_1}{P}}{\top},
  where $\intSetRq{C_1}{P}$ is mapped to $\{ \stOf{C_2} = I; \stOf{P} = M \}$.
\item \msgrule{\objSetRq{C_2}{v}}{\stOf{C_2} \neq M}{\intSetRq{C_2}{P}}{\top},
...
synthesize four rules corresponding to \intGetRq{C_i}{P} and \intSetRq{C_i}{P}
(for $i = 1, 2$), which are generated when synthesizing \objGetRq{C_i} and
\objSetRq{C_i}{v} above.
