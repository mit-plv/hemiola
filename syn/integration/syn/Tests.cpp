...
void RandomAddrRWTest::loop() {
  ...
  case 0:
    printf("req 0 %d %lx\n", rw, addr);
    rqIfc->putRq0(rw, addr, 0x0);
    break;
  case 1:
    printf("req 1 %d %lx\n", rw, addr);
    rqIfc->putRq1(rw, addr, 0x0);
    break;
  case 2:
    printf("req 2 %d %lx\n", rw, addr);
    rqIfc->putRq2(rw, addr, 0x0);
    break;
  case 3:
    printf("req 3 %d %lx\n", rw, addr);
    rqIfc->putRq3(rw, addr, 0x0);
    break;
  case 4:
    printf("req 4 %d %lx\n", rw, addr);
    rqIfc->putRq4(rw, addr, 0x0);
    break;
  case 5:
    printf("req 5 %d %lx\n", rw, addr);
    rqIfc->putRq5(rw, addr, 0x0);
    break;
  case 6:
    printf("req 6 %d %lx\n", rw, addr);
    rqIfc->putRq6(rw, addr, 0x0);
    break;
  case 7:
    printf("req 7 %d %lx\n", rw, addr);
    rqIfc->putRq7(rw, addr, 0x0);
    break;
  default: break;
  }
}
